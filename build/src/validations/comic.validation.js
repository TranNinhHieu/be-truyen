...
exports.ComicValidation = void 0;
  ...
  var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(req, res, next) {
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          condition = _joi["default"].object({
            title: _joi["default"].string().min(3).max(100).trim(),
            description: _joi["default"].string()["default"]('Đang cập nhật'),
            tagID: _joi["default"].array().items(_joi["default"].string()),
            thumbnail: _joi["default"].string(),
            author: _joi["default"].string()["default"]('Đang cập nhật')
          });
          _context2.prev = 1;
          _context2.next = 4;
...
exports.ComicValidation = ComicValidation;